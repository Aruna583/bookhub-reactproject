...
class BookItemDetails extends Component {
  state = {
    bookDetailsData: {},
    bookDetailsApi: bookDetailsApiStatuses.initial,
  }
  ...
  getBookDetailsApi = async () => {
    this.setState({bookDetailsApi: bookDetailsApiStatuses.inProgress})
    ...
    if (response.ok === true) {
      ...
      this.setState({
        ...
        bookDetailsApi: bookDetailsApiStatuses.success,
      })
    } else {
      this.setState({bookDetailsApi: bookDetailsApiStatuses.failure})
    }
  }
